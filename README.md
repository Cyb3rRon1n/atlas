...
- ✅ Multi-node fleet view (`atlas fleet doctor`/`trends`) — SSHes into each configured node and runs `atlas doctor`/`atlas trends --json` there, no daemon or central server
