...
ACTION_INSTRUCTIONS = (
    ...
    "cap, not how many CPUs or how much RAM the guest OS sees. (7) Restart "
    "a libvirt/KVM guest (action type \"restart_libvirt_guest\", with "
    "\"target\" set to the guest's name, as it literally appears in the "
    ...
    "should leave \"action\" as null. Never invent a container name, "
    "vmid, or libvirt guest name that is not present in the provided data."
)
